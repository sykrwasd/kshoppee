...
export default function ClosingReport() {
  ...
  const handleSelect = (index: number, selectedName: string) => {
    ...
    setRows((prevRows) => {
      ...
      updated[index].amount = quantity * Number(selectedItem.itemPrice);
  ...
  const handleQuantityChange = (index: number, qty: number) => {
    setRows((prevRows) => {
      ...
      const selectedItem = items.find(
        (i) => i.itemName === updated[index].itemName
      );
      if (selectedItem) {
        updated[index].amount = qty * Number(selectedItem.itemPrice);
      }
      return updated;
    });
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 text-xl font-medium tracking-wide">
            Track your daily sales and inventory with precision
          </p>
        </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="space-y-2">
                <label className="block text-sm font-bold text-gray-700 font-['Poppins',sans-serif] uppercase tracking-wide">
                  Name
                </label>
                <input
                  type="text"
            ...
            <div className="mb-8">
              ...
              {rows.map((row, index) => (
                <div
                  key={index}
                  className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 p-4 bg-gray-50/50 rounded-xl border border-gray-200/50"
                >
                  <select
                  ...
                  >
                    ...
                    {items.map((item) => (
                      <option
                        key={item.itemName}
                        value={item.itemName}
                        className="text-gray-700 font-['Inter',sans-serif]"
                      >
                        {item.itemName} - RM{item.itemPrice}
                      </option>
                    ))}
                  </select>
              ...
              {rows.length === 0 && (
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-xl font-bold font-['Poppins',sans-serif] mb-2">
                    No items added yet
                  </p>
                  <p className="text-base font-medium font-['Inter',sans-serif]">
                    Click &quot;Add Item&quot; to start building your report
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="mb-8">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl border border-blue-200/50">
                <label className="block text-sm font-bold text-gray-700 mb-2 font-['Poppins',sans-serif] uppercase tracking-wide">
                  Total Amount
                </label>
                <div className="flex items-center">
                  <span className="text-3xl font-black text-blue-600 font-['Poppins',sans-serif]">
                    RM
                  </span>
                  <input
                    type="text"
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <button
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 font-['Poppins',sans-serif]"
                onClick={handlePrint}
              >
                <svg
                  className="w-5 h-5 mr-2"
        ...
        <footer className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 transition-colors duration-200">
            ...
            <span className="text-sm font-semibold font-['Inter',sans-serif]">
